    ...
    <div class="flex items-center justify-center p-2 overflow-hidden font-sans bg-gray-100 min-w-screen">
        <div class="w-full m-5 lg:w-5/6">
            <div class="flex flex-wrap-reverse items-center justify-between">
                <input class="w-full h-10 px-5 border rounded sm:w-2/3" type="text"  placeholder="search vente" wire:model.debounce.500ms="search">
                <button class="h-10 px-2 my-2 text-white bg-blue-500 border rounded">Nouvelle vente</button>
            </div>
