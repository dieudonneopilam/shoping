@extends('layouts.app')
@section('main')
 <div class="w-11/12 mt-24 mx-auto bg-white p-10 rounded-lg">
    <div class="text-5xl font-extrabold text-center mb-5">
        <span class="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-violet-500">
          Gestion
        </span>
      </div>
    <div class="gap-4 grid  grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 mx-auto mt-5 place-content-center">
        <div class="flex flex-col items-center p-5 bg-white rounded-lg shadow-lg border">
        ...
        <div class="flex flex-col items-center p-5 bg-white rounded-lg shadow-lg border">
            ...
            <a class="block w-11/12 p-1 mt-4 text-center rounded-full border-x-2 border-y-2 border-sky-400 hover:bg-sky-400" href="{{ route('rapport') }}">Rapport</a>
        </div>
     </div>
 </div>
@endsection
