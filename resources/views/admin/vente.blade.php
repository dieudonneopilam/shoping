@extends('layouts.app')
@section('main')
<div class="w-10/12 mt-28 mr-auto ml-auto">
    <h1 class=" text-3xl text-bold">Vos Ventes</h1>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
        <div class="flex items-center justify-between py-4 bg-white dark:bg-gray-800 pr-5 pl-5">
            <div>
            ...
            <tbody>
                <tr
                    ...
                    <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                        <img class="w-10 h-10 rounded-full" src="{{ asset('img/habit.jpg') }}"
                            alt="Jese image">
                        <div class="pl-3">
