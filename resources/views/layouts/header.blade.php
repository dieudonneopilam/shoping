        ...
        <div>
            ...
            <nav class="items-center hidden md:flex">
                ...
                <li class="inline pr-3 ml-4 text-lg">
                    ...
                    @else
                        <a class="flex items-center text-white" href=""><img class="w-10 h-10 rounded-full"
                                src="{{ asset('img/habi.jpg') }}" alt="" srcset="">
                        </a>
                    @endisset
                </li>
            </nav>
    ...
    <nav :class="{ 'hidden': false }" x-show='open' x-transition.duration.500ms x-on:click.outside='open=false'
        ...
        <div class="w-full p-5">
            ...
            @else
                ...
                <span class="block mt-2 text-lg font-medium">connectez-vous</span>
            @endisset
